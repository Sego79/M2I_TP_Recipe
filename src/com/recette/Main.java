            ...
            do {
                ...
                switch (choixUser) {
                    case 1:
                        ...
                        Recipe recipe = new Recipe(context, theme, opinion, nameRecipe, descriptionRecipe, duration, nbPeople, 1);
                        DaoRecipe.create(recipe);
                        //Recipe.findIngredientInRecipe(recipe);
                    ...
                    case 2:
                        ...
                        switch (choixSelectionRecette) {
                            ...
                            case 4:
                                ...
                                String nameRecipe5 = "dinde";
                                System.out.println("--------------------------------------------");
                                Recipe recipeName = DaoRecipe.findRecetteByName(nameRecipe5);
                                List<Integer> listIdIngredientFromRecipe = DaoRecipe.findIdIngredientFromRecipe(recipeName);
                                System.out.println(listIdIngredientFromRecipe.size());
                                //IngredientJdbcDao.setIdIngredientFromRecipe(listIdIngredientFromRecipe);
                                //DaoIngredient.SelectIngredientByRecipe();
...
//TODO : J'arrive a recuperer des ingredients d'une recette en fonction de ce qu'il y a dans contenir
        //DaoRecipe.findIdIngredientFromRecipe();
